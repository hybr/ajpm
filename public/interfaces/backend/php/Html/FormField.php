...
class Html_FormField extends Html_Root2 {
	function __construct($opts = array()) {
		...
		$this->setOptionDefault ( 'class', 'ajpm-html-form-field' );
	}
	...
	public function show() {
		...
		/* first findout which framework you are using to show the field */
		/* request_type will tell me if it is admin interface or web interface */
		/* admin interface runs on jquery, web interface runs on angular */
